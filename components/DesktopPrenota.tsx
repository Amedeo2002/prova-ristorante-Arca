...
export default function DesktopPrenota({ lang }: { lang: string }) {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <div className="bg-[#3F4F44] text-[#DCD7C9] p-6 rounded-lg shadow-lg mb-8 text-center">
        <h2 className="text-2xl font-semibold mb-2">{t.callUs}</h2>
        <div className="text-2xl sm:text-3xl lg:text-4xl font-bold flex items-center justify-center mb-4 whitespace-nowrap">
          <Phone className="mr-2 h-6 w-6 lg:h-8 lg:w-8" />
          (+39) 045 9232674
        </div>
        <p className="text-lg text-[#CBD2A4]">{t.hours}</p>
      </div>

      <h2 className="text-2xl font-bold mb-4">{t.mapTitle}</h2>
